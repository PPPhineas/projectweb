<template>
  <div class="addproRisk">
    <div class="addproRisk-header">新增项目风险</div>
    <div class="addproRisk-form">
      <DataForm 
...
import { addProRiskInfo } from '@/api/proRisk';
...
export default {
  ...
  methods: {
    ...
    async handleClick() {
      ...
      //   if(valid) {
          let res = await addProRiskInfo(params);
